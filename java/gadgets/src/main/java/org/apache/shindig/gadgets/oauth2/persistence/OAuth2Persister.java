...
public interface OAuth2Persister {
  ...
  OAuth2Token findToken(String providerName, String gadgetUri, String user, String scope, OAuth2Token.Type type)
      throws OAuth2PersistenceException;

  boolean removeToken(String providerName, String gadgetUri, String user, String scope, OAuth2Token.Type type);
}
