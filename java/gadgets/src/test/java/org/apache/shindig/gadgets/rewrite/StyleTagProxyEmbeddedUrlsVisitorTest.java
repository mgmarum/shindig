...
public class StyleTagProxyEmbeddedUrlsVisitorTest extends DomWalkerTestBase {
  ...
  public void setUp() throws Exception {
    ...
    injector = Guice.createInjector(
        new PropertiesModule(), new DefaultGuiceModule(), new OAuthModule(), new OAuth2Module(), new OAuth2PersistenceModule(), new OAuth2MessageModule(), new OAuth2HandlerModule());
