...
public class DefaultRequestPipelineTest {
  ...
  public static class FakeOAuth2RequestProvider implements Provider<org.apache.shindig.gadgets.oauth2.OAuth2Request> {
	    protected int fetchCount = 0;
	    protected HttpRequest httpRequest;
	    protected HttpResponse httpResponse;
	    ...
	    private final org.apache.shindig.gadgets.oauth2.OAuth2Request oauth2Request = new BasicOAuth2Request(null, null, null, null, null, null, null, null) {
	      @Override
	      public HttpResponse fetch(HttpRequest request) {
	        fetchCount++;
	        httpRequest = request;
	    ...
	    public org.apache.shindig.gadgets.oauth2.OAuth2Request get() {
